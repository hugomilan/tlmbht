...
![Geometry of the problem used to validate the triangle element for the Pennes equation in 2D](https://github.com/hugomilan/tlmbht/blob/master/docs/images/2D_Triangle_Pennes_Problem.png "Geometry of the problem used to validate the triangle element for the Peat equation in 2D")
