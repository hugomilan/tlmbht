Here, I will walk you through in how to use the TLM method to solve the Diffusion equation in 2D with the element Triangle and we will also validated the tlmbht predictions using an analytical solution.
...
![Geometry of the problem used to validate the triangle element for the diffusion equation in 2D](https://github.com/hugomilan/tlmbht/blob/master/docs/_includes/images/2D_Triangle_Diffusion_Problem.png "Geometry of the problem used to validate the triangle element for the diffusion equation in 2D")
