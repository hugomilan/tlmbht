...
![Geometry of the problem used to validate the triangle element for the Heat equation in 2D](https://github.com/hugomilan/tlmbht/blob/master/docs/_includes/images/2D_Triangle_Heat_Problem.png "Geometry of the problem used to validate the triangle element for the Heat equation in 2D")
...
![Predictions using tlmbht with triangles vs. predictions using analytical solution for the 2D problem](https://github.com/hugomilan/tlmbht/blob/master/docs/_includes/images/2D_Triangle_Heat_Result.png "Predictions using tlmbht with triangles vs. predictions using analytical solution for the 2D problem")
