...
unsigned int MaterialHexahedronPennesEigen(struct dataForSimulation *, struct calculationTLMEigen *, int);

unsigned int MaterialPyramidPennesEigen(struct dataForSimulation *, struct calculationTLMEigen *, int);
