...
number_Temp = save_1(1)*numbers(1) + save_1(2)*numbers(3);

% last position that has heat flux values
number_Flux = number_Temp + save_1(3)*numbers(3);

% last position that contains points positions
number_Points = save_1(1)*numbers(1) + ( save_1(2) || save_1(3) )*numbers(3);

% first position that has the position at the interface
number_Points_Flux = save_1(1)*numbers(1) + 1;
...
[Ttemp, qxAnatemp, qyAnatemp] = D2_BHE_f(Points_Output_1(1:number_Points,1)',  ...
             ...
             if (save_1(1))
             TotalDiff(2,i0) = sum(abs(Ttemp(1:numbers(1)) - output_1(1:numbers(1), i0)'));
             meanDiff(2,i0) = TotalDiff(2,i0)/numbers(1);
             MaxDiff(2,i0) = max(abs(Ttemp(1:numbers(1)) - output_1(1:numbers(1), i0)'));
             percentageError(2,i0) = sum(abs( 100*(Ttemp(1:numbers(1)) - output_1(1:numbers(1), i0)')./Ttemp(1:numbers(1)) ));
             MaxPercentageError(2,i0) = max(abs( 100*(Ttemp(1:numbers(1)) - output_1(1:numbers(1), i0)')./Ttemp(1:numbers(1)) ));
             meanPercentage(2,i0) = percentageError(2,i0)/numbers(1);
             ...
             plot(Points_Output_1(1:numbers(1),2), Ttemp(1:numbers(1))', '*b')
             hold on 
             plot(Points_Output_1(1:numbers(1),2), output_1(1:numbers(1), i0), '*r')
             ...
             TotalDiff(3,i0) = sum(abs(Ttemp( (1 + numbers(1)*save_1(1) ):number_Temp ) - output_1((1 + numbers(1)*save_1(1) ):number_Temp, i0)'));
             MaxDiff(3,i0) = max(abs(Ttemp( (1 + numbers(1)*save_1(1) ):number_Temp ) - output_1((1 + numbers(1)*save_1(1) ):number_Temp, i0)'));
             meanDiff(3,i0) = TotalDiff(3,i0)/numbers(3);
             percentageError(3,i0) = sum(abs( 100*(Ttemp( (1 + numbers(1)*save_1(1) ):number_Temp ) - output_1((1 + numbers(1)*save_1(1) ):number_Temp, i0)')./Ttemp( (1 + numbers(1)*save_1(1) ):number_Temp ) ));    
             MaxPercentageError(3,i0) = max(abs( 100*(Ttemp( (1 + numbers(1)*save_1(1) ):number_Temp ) - output_1((1 + numbers(1)*save_1(1) ):number_Temp, i0)')./Ttemp( (1 + numbers(1)*save_1(1) ):number_Temp ) ));
             meanPercentage(3,i0) = percentageError(3,i0)/numbers(3);
             ...
             set(0,'CurrentFigure',figure_Temp)
             plot(Points_Output_1((1 + numbers(1)*save_1(1) ):number_Temp,2), Ttemp((1 + numbers(1)*save_1(1) ):number_Temp)', 'ob')
             hold on 
             plot(Points_Output_1((1 + numbers(1)*save_1(1) ):number_Temp,2), output_1((1 + numbers(1)*save_1(1) ):number_Temp, i0), 'or')
             end
             ...
             meanDiffFlux(1,i0) = TotalDiffFlux(1,i0)/numbers(3);
             ...
             meanPercentageFlux(1,i0) = percentageErrorFlux(1,i0)/numbers(3);
