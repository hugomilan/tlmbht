The Diffusion, Heat, and Pennes equations have similar form (also called isomorphic). We explore the isomorphism of these equations to use analytical solutions (D1_BHE_f.m and D1_HEAT_f.m) to validate these three equations.
